...
public class CounterClient {
    ...
    public static void main(final String[] args) throws Exception {
        if (args.length != 2) {
            ...
            System.out
                .println("Example: java com.alipay.sofa.jraft.example.counter.CounterClient counter 127.0.0.1:8087,127.0.0.1:8088,127.0.0.1:8089");
            System.exit(1);
        }
        final String groupId = "counter";
        final String confStr = "127.0.0.1:8082";
        ...
        for (int i = 0; i < n; i++) {
            incrementAndGet(cliClientService, leader, 1000, latch);
        }
        latch.await();
